"""Module to handle custom file log handler for forms-flow-custom-services."""
import gzip
import logging
...
def register_log_handlers(app, log_file, when, interval, backupCount, configure_log_file: bool = True):
    ...
    # Configure root logger and Flask app logger
    ...
    if configure_log_file and log_file:
        ...
        # Add handlers to the root logger and Flask logger
