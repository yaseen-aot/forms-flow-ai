...
Update deployment/docker/docker-compose.yml to override the forms-flow-bpm entrypoint as required to load the external JAR plugin via PropertiesLauncher:
